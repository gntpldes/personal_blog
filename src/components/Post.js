...
export default function Post(){
    ...
    return(
        <main className="bg-navy-100 min-h-screen p-12">
            <section className="container mx-auto">
                <h1 className="text-5xl flex justify-content-center cursive">Blog Posts Page</h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols gap-8">
                    ...
                    <article>
                        ...
                        >
                            ...
                            />
                            <span className="block relative h-full flex justify-end items-end pr-4 pb-3">
